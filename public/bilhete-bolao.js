...
async function init(){
  ...
  <p class="test-warning">Este bilhete usa dinheiro fictício e não vale prêmio real.</p><button class="secondary" onclick="location.reload()">Atualizar pontuação</button>`;
}
